...
public class PathfindAStar<T>
{
    ...
    public List<T> RunPathfinding(T initial, SatisfiesCondition satisfiesCondition, GetNeighbour getNeigbours, GetConnectionCost getConnectionCost, GetHeuristic getHeuristic ,float watchdog = 150)
    {
        watchdog--;
